...
Searcher can subscribe [Private Mempool](../../../../streams/mempool/bsc/private-mempool.md) to execute the backrun strategy, and then send the [backrun bundles](searcher.md#request-parameters) to BlockRazor RPC to obtain benefits via backrun auction.
