...
Searchers can subscribe to transactions from the [Private Mempool](/broken/pages/wLZGvdZPzO8Au0Yw077N) to execute backrun strategies, and then send bid to BlockRazor RPC to win the backrun auction.&#x20;
...
Searchers can also act as project builders to send raw bundles. For details, please refer to [Project Builder](eth_sendbundle.md).
